	...
	(function(){
		...
		function setMap(){
    		...
    		q.defer(d3.csv, "/mywork/Module_10/data/state_migration_outflow_perc_round_approx_trans.csv") //load attributes from csv
        		.defer(d3.json, "/mywork/Module_10/data/stateProperty.json") //load background spatial data
        		.await(callback);
